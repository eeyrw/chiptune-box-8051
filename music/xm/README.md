...
The initial 390-file Cerror/Dalezy/Dubmood scan produced 143 flash-fitting tracks,
nine semantically compatible but oversized tracks, and 238 incompatible tracks.
The retained collection also includes JAM / Simple Chip Tune, Mod Archive / Super
Mario 2, Traven / Tetris GB high scores, Beethoven / Fur Elise, Rez + Kenet /
Unreeeal Superhero 3, and Quazar / Funky Stars. After faithful linear-volume
lowering and rebuilding all stored T10P files, all 149 collection tracks fit individually. They do not fit
together in one internal-Flash playlist.
...
The report must show 149 verified and zero invalid files. Its `source_url` column
