...
Collected and verified on 2026-08-13. The directory contains 146 complete XM/T10P
pairs: 13 compile without warnings (`exact`), while 133 use one or more explicitly
...
semantically compatible but oversized tracks, and 238 incompatible tracks. Three
additional accepted files are JAM / Simple Chip Tune, Mod Archive / Super Mario 2,
and Traven / Tetris GB high scores. Tracks fit individually, not together in one
internal-Flash playlist.
...
The report must show 146 verified and zero invalid files. Its `source_url` column
